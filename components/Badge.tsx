...
export default function Badge(props: Data) {
  return (
    <a
      href={props.link}
      class="flex text-sm hover:ring-2 hover:ring-stone-200 font-medium opacity-75 items-center gap-2 border border-[#CCCCCC] bg-white bg-opacity-40 px-4 py-1.5 rounded-full shadow-[0px_0px_52px_-27px_rgba(0,0,0,0.75)]"
    >
