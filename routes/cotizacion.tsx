    ...
    <main id="Cotizacion" class="w-full py-6">
      <section class="mx-auto max-w-6xl">
        <div class="text-center flex flex-col gap-4 justify-center items-center p-4">
          ...
          <h2 class="font-regular text-xl sm:text-2xl max-w-2xl opacity-50">
        ...
        <form class="flex flex-col gap-4 max-w-xl mx-auto p-4" action="">
          <div class="flex flex-col sm:flex-row justify-center gap-4 mb-6">
            <div class="flex flex-col w-full">
              <InputForm name="name" label="Nombre" placeholder="Introduce tu nombre"/>
            </div>

            <InputForm name="email" label="Correo electronico" placeholder="Introduce tu correo electronico"/>
          </div>
          ...
          <InputForm name="web" label="Pagina web de ejemplo/inspiracion" placeholder="ej: www.fraintstudio.com" extraStyle=" w-fit"/>
        </form>
