...
const cardContactStyle = {
  card:
    "relative shadow-sm hover:ring-4 bg-[#f8f8f8] hover:ring-orange-200 group text-start flex flex-col cursor-pointer hover:text-white hover:bg-orange-400 hover:scale-105 transition  justify-between  border border-stone-200 min-w-[280px] sm:min-w-[300px] sm:min-h-[200px] rounded-xl p-4",
  badge:
